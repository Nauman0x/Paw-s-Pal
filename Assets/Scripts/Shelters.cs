...
public class Shelters : MonoBehaviour
{
    ...
    public bool useTestLocation = false; // Default to false for mobile builds
    public Vector2 testLocation = new Vector2(31.5204f, 74.3587f); // Lahore coordinates
    ...
    IEnumerator InitializeLocation()
    {
        if (useTestLocation)
        {
            // Use test location in Unity editor
